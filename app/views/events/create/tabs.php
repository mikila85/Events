        ...
        <div id="country1" style="display: block;">
            <div class="edit_form">
                ...
                <div class="edit_form_content nospace">
                    <div class="form_text">* Name of place:<br><input name="" type="text" class="size1"> <a href="#"><img src="/images/create-event-ico1.png" alt=""></a></div>
                    <div class="form_text">
                        <div class="text3">* Start date:<br><input name="" type="text" value="00/00/0000" class="size3"> <a href="#"><img src="/images/create-event-ico2.png" alt=""></a></div>
                        <div class="text3">* Start date:<br><input name="" type="text" value="00/00/0000" class="size3"> <a href="#"><img src="/images/create-event-ico2.png" alt=""></a></div>
                    </div>
                    <div class="form_text">* Address:<br><input name="" type="text" class="size1"></div>
                    <div class="form_text">
                        <div class="text1">* Zip code:<br><input name="" type="text" class="size2"></div>
                        <div class="text4">* Country:<br><input name="" type="text" class="size4"></div>
                        <div class="text4">* Country:<br><input name="" type="text" class="size4"></div>
                    </div>
                    <div class="form_text">
                        <div class="text5">* Entry time:</div>
                        <div class="text6"><input name="" type="text" class="size2"></div>
                    ...
                    <div class="form_text">
                        ...
                        <div class="text3"><input name="" type="text" value="00/00/0000" class="size3"> <a href="#"><img src="/images/create-event-ico2.png" alt=""></a></div>
                    </div>
                    <div class="form_text">
